...
def init_db():
    ...
    try:
        ...
        _create_subscription_and_log_tables(cursor)
        _create_inventory_tables(cursor)
        _create_actor_mapping_tables(cursor)
        _create_download_candidate_tables(cursor)
        _create_video_variant_tables(cursor)
        _create_emby_snapshot_tables(cursor)
        conn.commit()
    finally:
        conn.close()
...
def _init_external_databases() -> None:
...
def _create_download_tables(cursor) -> None:
    cursor.execute('''
...
def _create_subscription_and_log_tables(cursor) -> None:
    cursor.execute('''
...
def _create_inventory_tables(cursor) -> None:
    cursor.execute('''
...
def _create_actor_mapping_tables(cursor) -> None:
    cursor.execute('''
...
def _create_download_candidate_tables(cursor) -> None:
    cursor.execute('''
...
def _create_video_variant_tables(cursor) -> None:
    cursor.execute('''
...
def _create_emby_snapshot_tables(cursor) -> None:
    cursor.execute('''
