...
import {
  PROVIDER_KEYS,
  PROVIDER_META,
  firstNetworkProvider as firstNetworkProviderKey,
  normalizeProvider as normalizeProviderKey,
  providerLabel as formatProviderLabel,
  providerOrderLabel as formatProviderOrderLabel,
...
export default {
  ...
  methods: {
    ...
    providerOrderLabel(order) {
      return formatProviderOrderLabel(order)
    },
    normalizeProvider(provider) {
      return normalizeProviderKey(provider)
    },
    firstNetworkProvider(order) {
      return firstNetworkProviderKey(order)
    },
    percentValue(item = {}) {
