...
test('modal actions use liquid glass control tokens instead of hardcoded pills', () => {
  ...
  assert.match(sourceBlock(source, '.preview-btn:focus-visible,\n.stream-btn:focus-visible:not(:disabled),\n.favorite-btn:focus-visible'), /box-shadow:\s*var\(--modal-action-shadow-hover\),\s*0 0 0 4px rgba\(var\(--accent-rgb\),\s*0\.12\)/)
  assert.match(sourceBlock(source, '.stream-download-btn:focus-visible:not(:disabled)'), /outline:\s*none/)
  assert.match(sourceBlock(source, '.stream-download-btn:focus-visible:not(:disabled)'), /box-shadow:\s*var\(--modal-action-shadow-hover\),\s*0 0 0 4px rgba\(var\(--accent-rgb\),\s*0\.12\)/)
...
test('modal people chips and lightbox controls use shared glass surfaces', () => {
  ...
  assert.match(sourceBlock(source, '.modal-close:focus-visible'), /box-shadow:\s*var\(--modal-chip-shadow-hover\),\s*0 0 0 4px rgba\(var\(--accent-rgb\),\s*0\.12\)/)
  assert.match(sourceBlock(source, '.lightbox-close:focus-visible'), /outline:\s*none/)
  assert.match(sourceBlock(source, '.lightbox-close:focus-visible'), /box-shadow:\s*var\(--modal-chip-shadow-hover\),\s*0 0 0 4px rgba\(var\(--accent-rgb\),\s*0\.12\)/)
  ...
  assert.match(sourceBlock(source, '.lightbox-prev:focus-visible:not(:disabled), .lightbox-next:focus-visible:not(:disabled)'), /box-shadow:\s*var\(--modal-chip-shadow-hover\),\s*0 0 0 4px rgba\(var\(--accent-rgb\),\s*0\.12\)/)
