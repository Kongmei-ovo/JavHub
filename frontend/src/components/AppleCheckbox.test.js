...
test('AppleCheckbox matches iOS checkbox geometry and animated check stroke', () => {
  ...
  assert.match(box, /transition:\s*background var\(--apple-form-motion-spring\),\s*border-color var\(--apple-form-motion-spring\),\s*box-shadow var\(--apple-form-motion-spring\)/)
  ...
  assert.match(mark, /transition:\s*stroke-dashoffset var\(--apple-form-motion-spring\)/)
